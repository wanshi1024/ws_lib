...
(function(global, $) {
    ...
    var cssMap = {
        // 改这里
        '.toast-message': '{position:fixed;left:50%;top:60%;transform:translateX(-50%);border:1px solid #EBEEF5;width:138px;transition:top .3s ease-out;opacity .3s ease-out;padding:10px 20px 10px 15px;display:flex;align-items:center;z-index:2000;}',
